...
constexpr Uint8Field zonesState(RW, 6, 6, 2);          // TOP94: bits 7-6, Zones state (3 states) - RW: SetZones
...
constexpr Int8Field bivalentStartTemp(RW, 65);          // TOP131: Bivalent start temp (value-128=°C) - RW: SetBivalentStartTemp
constexpr Int8Field bivalentAdvancedStartTemp(RW, 66);  // TOP134: Bivalent advanced start temp (value-128=°C) - RW: SetBivalentAPStartTemp
constexpr Uint8Field bivalentStartDelay(RW, 67);        // TOP136: Bivalent start delay (value-1) - RW: protocol symmetry (no HeishaMon setter)
constexpr Int8Field bivalentAdvancedStopTemp(RW, 68);   // TOP135: Bivalent advanced stop temp (value-128=°C) - RW: SetBivalentAPStopTemp
constexpr Uint8Field bivalentStopDelay(RW, 69);         // TOP137: Bivalent stop delay (value-1) - RW: protocol symmetry (no HeishaMon setter)
constexpr Uint8Field bivalentAdvancedDhwDelay(RW, 70);  // TOP138: Bivalent advanced DHW delay (value-1) - RW: protocol symmetry (no HeishaMon setter)

// Byte 75-98 - Heating/cooling curve settings (Int8Field - getIntMinus128: value-128=°C)
constexpr Int8Field z1HeatCurveTargetHighTemp(RW, 75);   // TOP29: Z1 heating curve target high temp - RW: SetCurves
constexpr Int8Field z1HeatCurveTargetLowTemp(RW, 76);    // TOP30: Z1 heating curve target low temp - RW: SetCurves
constexpr Int8Field z1HeatCurveOutsideLowTemp(RW, 77);   // TOP32: Z1 heating curve outside low temp - RW: SetCurves
constexpr Int8Field z1HeatCurveOutsideHighTemp(RW, 78);  // TOP31: Z1 heating curve outside high temp - RW: SetCurves
constexpr Int8Field z2HeatCurveTargetHighTemp(RW, 79);   // TOP82: Z2 heating curve target high temp - RW: SetCurves
constexpr Int8Field z2HeatCurveTargetLowTemp(RW, 80);    // TOP83: Z2 heating curve target low temp - RW: SetCurves
constexpr Int8Field z2HeatCurveOutsideLowTemp(RW, 81);   // TOP85: Z2 heating curve outside low temp - RW: SetCurves
constexpr Int8Field z2HeatCurveOutsideHighTemp(RW, 82);  // TOP84: Z2 heating curve outside high temp - RW: SetCurves
constexpr Int8Field heatingOffOutdoorTemp(RW, 83);       // TOP77: Heating off outdoor temp - RW: SetHeatingOffOutdoorTemp
constexpr Int8Field heatDelta(RW, 84);                   // TOP23: Heat delta (value-128=°K) - RW: SetFloorHeatDelta
constexpr Int8Field heaterOnOutdoorTemp(RW, 85);         // TOP78: Heater on outdoor temp - RW: protocol symmetry (no HeishaMon setter)
constexpr Int8Field z1CoolCurveTargetHighTemp(RW, 86);   // TOP72: Z1 cooling curve target high temp - RW: SetCurves
constexpr Int8Field z1CoolCurveTargetLowTemp(RW, 87);    // TOP73: Z1 cooling curve target low temp - RW: SetCurves
constexpr Int8Field z1CoolCurveOutsideLowTemp(RW, 88);   // TOP75: Z1 cooling curve outside low temp - RW: SetCurves
constexpr Int8Field z1CoolCurveOutsideHighTemp(RW, 89);  // TOP74: Z1 cooling curve outside high temp - RW: SetCurves
constexpr Int8Field z2CoolCurveTargetHighTemp(RW, 90);   // TOP86: Z2 cooling curve target high temp - RW: SetCurves
constexpr Int8Field z2CoolCurveTargetLowTemp(RW, 91);    // TOP87: Z2 cooling curve target low temp - RW: SetCurves
constexpr Int8Field z2CoolCurveOutsideLowTemp(RW, 92);   // TOP89: Z2 cooling curve outside low temp - RW: SetCurves
constexpr Int8Field z2CoolCurveOutsideHighTemp(RW, 93);  // TOP88: Z2 cooling curve outside high temp - RW: SetCurves
constexpr Int8Field coolDelta(RW, 94);                   // TOP24: Cool delta (value-128=°K) - RW: SetFloorCoolDelta
constexpr Int8Field heatToCoolTemp(RW, 95);              // TOP79: Heat to cool temp - RW: protocol symmetry (no HeishaMon setter)
constexpr Int8Field coolToHeatTemp(RW, 96);              // TOP80: Cool to heat temp - RW: protocol symmetry (no HeishaMon setter)
constexpr Int8Field dhwHeatDelta(RW, 99);                // TOP22: DHW heat delta (value-128=°K) - RW: SetDHWHeatDelta
...
constexpr Uint8Field heaterDelayTime(RW, 104);           // TOP96: Heater delay time (value-1) - RW: SetHeaterDelayTime
constexpr Int8Field heaterStartDelta(RW, 105);           // TOP97: Heater start delta (value-128=°K) - RW: SetHeaterStartDelta
